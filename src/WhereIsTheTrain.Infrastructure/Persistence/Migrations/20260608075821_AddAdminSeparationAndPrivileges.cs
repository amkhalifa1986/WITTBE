...
{
    /// <inheritdoc />
    public partial class AddAdminSeparationAndPrivileges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminRolePrivileges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminRolePrivileges_AdminRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminRolePrivileges_RoleId_Module",
                table: "AdminRolePrivileges",
