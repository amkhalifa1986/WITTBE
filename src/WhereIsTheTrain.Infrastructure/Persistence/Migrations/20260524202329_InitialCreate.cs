        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LostFoundPosts_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trains_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainSuggestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainSuggestions_Users_SuggestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledArrival = table.Column<TimeSpan>(type: "time(6)", nullable: true),
                    ScheduledDeparture = table.Column<TimeSpan>(type: "time(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainRouteStops", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainRouteStops_Stops_StopId",
                        column: x => x.StopId,
                        principalTable: "Stops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainRouteStops_Trains_TrainId",
                        column: x => x.TrainId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripFollowers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripFollowers_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripFollowers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StatusTag = table.Column<int>(type: "int", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripLiveUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripLiveUpdates_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LostFoundPosts_AuthorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainRouteStops_StopId",
                table: "TrainRouteStops",
                column: "StopId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainRouteStops_TrainId_StopOrder",
                table: "TrainRouteStops",
                columns: new[] { "TrainId", "StopOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Trains_CreatedById",
                table: "Trains",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainSuggestions_SuggestedById",
                table: "TrainSuggestions",
                column: "SuggestedById");

            migrationBuilder.CreateIndex(
                name: "IX_TripFollowers_TripId",
                table: "TripFollowers",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TripFollowers_UserId_TripId",
                table: "TripFollowers",
                columns: new[] { "UserId", "TripId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TripLiveUpdates_AuthorId",
                table: "TripLiveUpdates",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_TripLiveUpdates_TripId_CreatedAt",
                table: "TripLiveUpdates",
                columns: new[] { "TripId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Trips_TrainId_TripDate",
                table: "Trips",
                columns: new[] { "TrainId", "TripDate" },
                unique: true);
